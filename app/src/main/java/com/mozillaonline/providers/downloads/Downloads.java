...
import com.xuzhiyong.comego.BuildConfig;
...
public final class Downloads implements BaseColumns {
    ...
    static {
        if (!BuildConfig.DEBUG) {
            AUTHORITY = "com.duowan.ada.downloads";
        } else {
            AUTHORITY = "com.duowan.ada.debug.downloads";
        }
    }
    /**
     * @hide
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS = "com.duowan.ada.permission.ACCESS_DOWNLOAD_MANAGER";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS_ADVANCED = "com.duowan.ada.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

    /**
     * The permission to access the all the downloads in the manager.
     */
    public static final String PERMISSION_ACCESS_ALL = "com.duowan.ada.permission.ACCESS_ALL_DOWNLOADS";
     ...
     * @hide
     */
    public static final String PERMISSION_SEND_INTENTS = "com.duowan.ada.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

    /**
     * The permission to download files without any system notification being
     * shown.
     */
    public static final String PERMISSION_NO_NOTIFICATION = "com.duowan.ada.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
     ...
     * com.duowan.ada.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED.
     * <P>
     * Type: INTEGER
     * </P>
     * <P>
