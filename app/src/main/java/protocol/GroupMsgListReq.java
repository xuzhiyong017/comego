...
public final class GroupMsgListReq extends Message {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GroupMsgListReq)) return false;
    return equals(groups, ((GroupMsgListReq) other).groups);
  }
  ...
  public static final class Builder extends Message.Builder<GroupMsgListReq> {
    ...
    public Builder(GroupMsgListReq message) {
      super(message);
      if (message == null) return;
      this.groups = copyOf(message.groups);
    }

    public Builder groups(List<GroupMsgReq> groups) {
