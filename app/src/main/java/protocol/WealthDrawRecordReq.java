 ...
 * 提现记录
 */
public final class WealthDrawRecordReq extends Message {
  ...
  private WealthDrawRecordReq(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof WealthDrawRecordReq)) return false;
    WealthDrawRecordReq o = (WealthDrawRecordReq) other;
  ...
  public static final class Builder extends Message.Builder<WealthDrawRecordReq> {
    ...
    public Builder(WealthDrawRecordReq message) {
      super(message);
    ...
    @Override
    public WealthDrawRecordReq build() {
      checkRequiredFields();
      return new WealthDrawRecordReq(this);
    }
  }
