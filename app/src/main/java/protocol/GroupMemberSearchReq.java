...
public final class GroupMemberSearchReq extends Message {
  ...
  @ProtoField(tag = 11)
  public final GroupMember template;

  private GroupMemberSearchReq(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GroupMemberSearchReq)) return false;
    GroupMemberSearchReq o = (GroupMemberSearchReq) other;
  ...
  public static final class Builder extends Message.Builder<GroupMemberSearchReq> {
    ...
    public GroupMember template;

    public Builder() {
    }

    public Builder(GroupMemberSearchReq message) {
      super(message);
    ...
    public Builder template(GroupMember template) {
      this.template = template;
      return this;
    }

    @Override
    public GroupMemberSearchReq build() {
      return new GroupMemberSearchReq(this);
    }
  }
