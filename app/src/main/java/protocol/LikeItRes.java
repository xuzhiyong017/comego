...
public final class LikeItRes extends Message {
  ...
  private LikeItRes(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof LikeItRes)) return false;
    LikeItRes o = (LikeItRes) other;
  ...
  public static final class Builder extends Message.Builder<LikeItRes> {
    ...
    public Builder(LikeItRes message) {
      super(message);
    ...
    @Override
    public LikeItRes build() {
      checkRequiredFields();
      return new LikeItRes(this);
    }
  }
