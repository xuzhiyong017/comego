...
public final class MGoldChangeRecordReq extends Message {
  ...
  private MGoldChangeRecordReq(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof MGoldChangeRecordReq)) return false;
    MGoldChangeRecordReq o = (MGoldChangeRecordReq) other;
  ...
  public static final class Builder extends Message.Builder<MGoldChangeRecordReq> {
    ...
    public Builder(MGoldChangeRecordReq message) {
      super(message);
    ...
    @Override
    public MGoldChangeRecordReq build() {
      return new MGoldChangeRecordReq(this);
    }
  }
