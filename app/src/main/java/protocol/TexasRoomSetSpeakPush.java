...
public final class TexasRoomSetSpeakPush extends Message {
  ...
  private TexasRoomSetSpeakPush(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof TexasRoomSetSpeakPush)) return false;
    TexasRoomSetSpeakPush o = (TexasRoomSetSpeakPush) other;
  ...
  public static final class Builder extends Message.Builder<TexasRoomSetSpeakPush> {
    ...
    public Builder(TexasRoomSetSpeakPush message) {
      super(message);
    ...
    @Override
    public TexasRoomSetSpeakPush build() {
      checkRequiredFields();
      return new TexasRoomSetSpeakPush(this);
    }
  }
