...
public final class UserHeartBeatRes extends Message {
  ...
  private UserHeartBeatRes(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof UserHeartBeatRes)) return false;
    UserHeartBeatRes o = (UserHeartBeatRes) other;
  ...
  public static final class Builder extends Message.Builder<UserHeartBeatRes> {
    ...
    public Builder(UserHeartBeatRes message) {
      super(message);
    ...
    @Override
    public UserHeartBeatRes build() {
      checkRequiredFields();
      return new UserHeartBeatRes(this);
    }
  }
