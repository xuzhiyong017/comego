...
public final class TexasPlayerWarRecordReq extends Message {
  ...
  private TexasPlayerWarRecordReq(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof TexasPlayerWarRecordReq)) return false;
    TexasPlayerWarRecordReq o = (TexasPlayerWarRecordReq) other;
  ...
  public static final class Builder extends Message.Builder<TexasPlayerWarRecordReq> {
    ...
    public Builder(TexasPlayerWarRecordReq message) {
      super(message);
    ...
    @Override
    public TexasPlayerWarRecordReq build() {
      return new TexasPlayerWarRecordReq(this);
    }
  }
