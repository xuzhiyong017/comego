...
int inject_remote_process(pid_t target_pid, const char *library_path, const char *function_name, const char *param, size_t param_size)
{
    ...
    if(map_base == (void*)(-1)) {
    	DEBUG_PRINT("[+] Remote mmap base: %x failed\n", map_base);
    }
...
//        return -1;
//    }
//    printf("Begin to attach  /data/libinject_so.so:hook_entry to /system/bin/surfaceflinger\n");
//    inject_remote_process(target_pid, "/data/libinject_so.so", "hook_entry",  "I'm parameter!", strlen("I'm parameter!"));
//    return 0;
//}
