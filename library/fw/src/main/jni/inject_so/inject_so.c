        ...
        if (shdr.sh_type == SHT_PROGBITS) {
            ...
            if (strcmp(&(string_table[name_idx]), ".got.plt") == 0
                ...
                for (i = 0; i < out_size; i += 4) {
                    ...
                    if (got_item  == (uint32_t)old_eglSwapBuffers) {
                        ...
                        *(uint32_t *)(out_addr + i) = (uint32_t)new_eglSwapBuffers;

                        break;
                    } else if (got_item == (uint32_t)new_eglSwapBuffers) {
                        LOGD("Already hooked\n");
                        break;
                    }
                }
