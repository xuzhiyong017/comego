...
public class ThreadBus {
    ...
    public static final int VideoCache = 6; // video cache
	public static final int Shit = 7;		// more ......
	public static final int Pool = 8;		// more fresh thread
	public static final int PoolTiming = 9; // caculate the timing for pool
	...
	public ThreadBus(String name){
		...
		addThread(Net, 		  "Net");
		addThread(Db, 		  "Db");
        addThread(VideoCache, "VideoCache");
		addThread(Shit, 	  "Shit");
